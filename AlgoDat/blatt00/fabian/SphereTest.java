...
public class SphereTest {
	...
	public void testCalculateArea() {
		...
		assertEquals("calculateArea() does not return the sphere Area", 113.097335529, dummySphere.calculateSurfaceArea(), delta);
	}
	...
	public void testCalculateDiameter() {
		...
		assertEquals("calculateDiamter() does not return the sphere Diameter", 6.0, dummySphere.calculateDiameter(), delta);
	}
